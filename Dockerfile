...
# rust builder → distroless runtime. The AIWars deps live in the PRIVATE AIWars repo, so
# the build fetches them via a BuildKit secret `gh_token` (a token that can read AsafFisher/AIWars).
#
